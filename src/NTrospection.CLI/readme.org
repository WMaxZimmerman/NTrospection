...
inputArgs = new string[]{"example", "hello", "?"};
Program.Main(inputArgs);
Console.WriteLine("==== Command Help ====");
...
inputArgs = new string[]{"example", "hello", "--neeeem", "World"};
Program.Main(inputArgs);
Console.WriteLine("==== Invalid Parameter Name ====");
...
inputArgs = new string[]{"example", "hello", "--name"};
Program.Main(inputArgs);
Console.WriteLine("==== Invalid Parameter Name ====");
...
The parameter 'neeeem' is not a valid parameter
